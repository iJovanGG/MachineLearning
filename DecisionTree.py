...
if __name__ == '__main__':
    # Reading data
    d = pd.read_csv("C:\\Users\Joki\Desktop\MachineLearning-master\datasets\income\adult.csv")[['age', 'hours-per-week', 'yearly-income']].dropna()

    # Constructing the X and Y matrices
    X = tree[['age', 'hours-per-week']]
    Y = tree['yearly-income'].values.tolist()

    # Initiating the Node
    root = Node(Y, X, max_depth=8, min_samples_split=9)
